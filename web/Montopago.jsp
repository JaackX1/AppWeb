                        ...
                        <div class="card mb-3">
                            <form>
                                <div class="card-body">                    
                                    ...
                                    <label class="text-xl text-gray-600">Pago total<span class="text-red-500"></span></label></br>
                                    <input type="number" style="width: 150%" class="form-control" id="inputDinamic" name="inputDinamic" value="${preciototal}" readonly=""></input>
                                    
                                    <br>
                                    <a href="paypal.jsp" class="btn btn-success">Pagar</a>
                                    <br>
                                </div>
                            </form>
                        </div>
