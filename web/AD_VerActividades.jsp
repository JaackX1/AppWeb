    ...
    <div class="main-body">
          <div class="row gutters-sm">
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                    <h6 class="mb-0" style="text-align: center">SELECCIONAR</h6>
                    <hr><!--
                    <form>
                    ...
                    <table id="contact-table" class="table is-fullwidth is-striped">
                        ...
                        <tr>
                            <td></td>
                            <td>Cliente</td>
                            <td><a class="btn btn-success" href="servletAdmin?accion=listarClientes">Seleccionar</a></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Profesional</td>
                            <td><a class="btn btn-success" href="servletAdmin?accion=listarProfesionales">Seleccionar</a></td>
                        </tr>
