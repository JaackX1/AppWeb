                ...
                <div class="col-sm-6 mb-3">
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-sm-7">
                          <h6 class="mb-0">Notificar atraso</h6>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-sm-7">
                          <h6 class="mb-0">Generar reportes</h6>
                        </div>
                        <div class="col-sm-1 text-secondary">
                          <a class="btn btn-success " target="" href="AD_GenerarReporte.jsp">Ingresar</a>
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                        <div class="col-sm-7">
                          <h6 class="mb-0">Controlar Pagos clientes</h6>
                        </div>
                        <div class="col-sm-1 text-secondary">
                            <a class="btn btn-secondary " target="" href="AD_ControlarPagos.jsp">Ingresar</a>
                        </div>
                      </div>
                      <hr>
                    </div>
                ...
                <div class="col-sm-6 mb-3">
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-sm-7">
                          <h6 class="mb-0">Visualizar Actividades</h6>
                        </div>
                        <div class="col-sm-1 text-secondary">
                          <a class="btn btn-success " target="" href="AD_VerActividades.jsp">Ingresar</a>
                        </div>
                      </div>
                    </div>
                  </div>
