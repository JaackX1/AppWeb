                        ...
                        <div class="card mb-3">
                            <form action="servletCapacitacion" method="POST">
                                <div class="card-body">                    
                                    ...
                                    <label class="text-xl text-gray-600">Fecha inicio capacitacion<span class="text-red-500"></span></label></br>
                                    <input type="text" style="width: 150%" class="form-control" name="inputStartDate" id="inputStartDate" value="" readonly="" >
                                    <hr>

                                    <label class="text-xl text-gray-600">Fecha fin capacitacion<span class="text-red-500"></span></label></br>
