                    ...
                    <table id="contact-table" class="table is-fullwidth is-striped">
                        ...
                        <c:forEach var="v" items="${visitasProf}">
                            <tr>
                                ...
                                <td><a class="btn btn-success" href="servletProf?accion=VerVisita&idc=${v.getId()}">Revisar</a></td>
                            </tr>
                        </c:forEach>
                        ...
                        <c:forEach var="c" items="${capacitacionesProf}">
                            <tr>
                                ...
                                <td>${c.getPrecio()}</td>
                                <td><a class="btn btn-success" href="servletProf?accion=VerCapacitacion&idc=${c.getId_capa()}">Revisar</a></td>
                            </tr>
                        </c:forEach>
                        ...
                        <c:forEach var="a" items="${asesoriasProf}">
                            <tr>
                                ...
                                <td>${a.getPrecio()}</td>
                                <td><a class="btn btn-success" href="servletProf?accion=VerAsesoria&idc=${a.getId_asesoria()}"> Revisar</a></td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
