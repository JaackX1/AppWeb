    ...
    <div class="main-body">
          <div class="row gutters-sm">
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                    <h6 class="mb-0" style="text-align: center">RESPONDER CHECKLIST</h6>
                    <hr><!--
                    <form>
                    ...
                    <table id="contact-table" class="table is-fullwidth is-striped">
                        ...
                        <c:forEach var="ch" items="${checklists}">
                        <tr>
                            <td>${ch.getRUT_EMPRESA()}</td>
                            <td>${ch.getEMPR_NOMBRE()}</td>
                            <td>${ch.getEMPR_TELEFONO()}</td>
                            <td><a class="btn btn-success" href="servletProf?accion=ResponderChecklist2&idc=${ch.getRUT_EMPRESA()}">Ver Checklist</a></td>
                        </tr>
                        </c:forEach>
