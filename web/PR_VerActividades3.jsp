    ...
    <div class="main-body">
          <div class="row gutters-sm">
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                    <h6 class="mb-0" style="text-align: center">DETALLE</h6>
                    <hr>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <h6 class="mb-0" style="text-align: center">DETALLE CHECKLIST</h6>
                    <hr>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-1">
                          <input disabled type="checkbox" name="chkResp" id="" value="1" <c:if test="${check1==1}"><% {out.print("checked");}%></c:if> >
                    ...
                    <div class="row">
                      <div class="col-sm-1">
                          <input disabled type="checkbox" name="chkResp" id="" value="1" <c:if test="${check2==1}"><% {out.print("checked");}%></c:if> >
                      </div>                      
                      <div class="col-sm-8">
                    ...
                    <div class="row">
                      <div class="col-sm-1">
                          <input disabled type="checkbox" name="chkResp" id="" value="1" <c:if test="${check3==1}"><% {out.print("checked");}%></c:if> >
                      </div>                      
                      <div class="col-sm-8">
                    ...
                    <div class="row">
                      <div class="col-sm-1">
                          <input disabled type="checkbox" name="chkResp" id="" value="1" <c:if test="${check4==1}"><% {out.print("checked");}%></c:if> >
                      </div>                      
                      <div class="col-sm-8">
                    ...
                    <div class="row">
                      <div class="col-sm-1">
                          <input disabled type="checkbox" name="chkResp" id="" value="1" <c:if test="${check5==1}"><% {out.print("checked");}%></c:if> >
                      </div>                      
                      <div class="col-sm-8">
                    ...
                    <c:if test="${ch.getObs6() ne null}">
                        <div class="row">
                            <div class="col-sm-1">
                                <input disabled type="checkbox" name="chkResp" id="" value="1" <c:if test="${check6==1}"><% {out.print("checked");}%></c:if> >
                            </div>                      
                            <div class="col-sm-8">
