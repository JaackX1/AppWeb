                    ...
                    <table id="contact-table" class="table is-fullwidth is-striped">
                        ...
                        <!--  PROFESIONAL -->
                            <tr>
                                ...
                                <td></td>
                                <td><a class="btn btn-success" href="servletProf?accion=VerActividadesCapacitaciones">Ver Capacitaciones</a></td>
                            </tr>
                            <tr>
                                <td>Visitas</td>
                                <td></td>
                                <td><a class="btn btn-success" href="servletProf?accion=VerActividadesVisitas">Ver Visitas</a></td>
                            </tr>
                            <tr>
                                <td>Asesorias</td>
                                <td></td>
                                <td><a class="btn btn-success" href="servletProf?accion=listarAsesoriaProf">Ver Asesorias</a></td>
                            </tr>
                    </table>
                </div>
              </div>
