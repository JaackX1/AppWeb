    ...
    <div class="main-body">
          <div class="row gutters-sm">
            ...
            <div class="col-md-8">
              ...
              <div class="card mb-3">
                <div class="card-body">
                    <h6 class="mb-0" style="text-align: center">DETALLE ASESORIA</h6>
                    <hr>
                    <c:forEach var="da" items="${datosAsesoria}">
                    <div class="row">
                      <div class="col-sm-3">
                        <h6 class="mb-0">Profesional a cargo</h6>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <h6 class="mb-0">Fecha de inicio</h6>
                      </div>
                      <div class="col-sm-9 text-secondary">
                        ${da.getFecha_inicio()}
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-9 text-secondary">
                          <c:if test="${da.getId_area()==1}">Industrial</c:if>
                          <c:if test="${da.getId_area()==2}">Minero</c:if>
                          <c:if test="${da.getId_area()==3}">Construccion</c:if>
                      </div>
                    </div>
                    <hr>
                    </c:forEach>
