    ...
    <div class="main-body">
          <div class="row gutters-sm">
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                    <h6 class="mb-0" style="text-align: center">LISTADO</h6>
                    <hr><!--
                    <form>
                    ...
                    <table id="contact-table" class="table is-fullwidth is-striped">
                        ...
                        <c:forEach var="c" items="${cliente}">
                            <tr>
                                ...
                                <td>${c.getEMPR_TELEFONO()}</td>
                                <td><a class="btn btn-success" href="servletAdmin?accion=BuscarCliente&idc=${c.getRUT_EMPRESA()}">Revisar</a></td>
                            </tr>
                        </c:forEach>
                        <c:forEach var="p" items="${profesional}">
                            <tr>
                                <td>${p.getRUN()}</td>
                                <td>${p.getPER_P_NOMBRE()}</td>
                                <td>${p.getPER_TELEFONO()}</td>
                                <td><a class="btn btn-success" href="servletAdmin?accion=BuscarProfesional&idc=${p.getRUN()}">Revisar</a></td>
                            </tr>
                        </c:forEach>
