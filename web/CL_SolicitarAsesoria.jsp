...
<head>
    ...
    <title>Cliente - Solicitar Asesoria</title>
    ...
    <div class="main-body">
          <div class="row gutters-sm">
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                    <h6 class="mb-0" style="text-align: center">SOLICITAR ASESORIA ESPECIAL</h6>
                    <hr>
                    <label class="text-xl text-gray-600">Dia <span class="text-danger-500">*</span></label></br>
                    <input type="text" style="width: 50%" class="border-2 border-gray-300 p-2 w-full" name="title" id="title" value="" required>
                    <hr>
                    <label class="text-xl text-gray-600">Hora <span class="text-danger-500">*</span></label></br>
                    <input type="text" style="width: 50%" class="border-2 border-gray-300 p-2 w-full" name="title" id="title" value="" required>
                    <hr>
                    <label class="text-xl text-gray-600">Motivo de asesoria especial</label></br>
